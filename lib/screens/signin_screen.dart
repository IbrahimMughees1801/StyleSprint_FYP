  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (_authService.isCurrentUserPasswordAccount &&
        ...
        widget.onEmailVerificationRequired();
      } else {
        widget.onSignIn();
      }
    } catch (e) {
      ...
      body: Stack(
        ...
        children: [
          Image.network(
            _backgroundImageUrl,
            fit: BoxFit.cover,
            color: AppTheme.atelierDark.withValues(alpha: 0.42),
          ...
          DecoratedBox(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  AppTheme.atelierDark.withValues(alpha: 0.92),
                  AppTheme.atelierMidnight.withValues(alpha: 0.82),
                  AppTheme.atelierDark.withValues(alpha: 0.96),
                ],
